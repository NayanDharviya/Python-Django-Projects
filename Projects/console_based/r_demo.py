...
##        with open("C:\\itvedant\\python\\project\\console_based\\restaurant.csv", 'r') as f:
...
##                        title[3] = 'b'
##                lines.append(line)
##        with open("C:\\itvedant\\python\\project\\console_based\\restaurant.csv", 'w', newline='') as f:
